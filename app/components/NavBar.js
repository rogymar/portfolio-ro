...
import perfil from '../../public/person.svg';
...
const CustomLink = ({ href, children, className = "" }) => {
    ...
    return (
        <Link href={href} className={`${className} relative group`}>
            ...
            <span className={`h-[3px] inline-block bg-rosita absolute left-0 bottom-[-6px] group-hover:w-full transition-[width] duration-300
